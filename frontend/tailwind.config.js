...
export default {
    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                // BRAND - Azul corporativo principal (más oscuro)
                brand: {
                    50: "#e8f0f8",
                    100: "#d1e1f1",
                    200: "#a3c3e3",
                    300: "#75a5d5",
                    400: "#4787c7",
                    500: "#1969b9", // Primary action (más oscuro)
                    600: "#145494", // Primary hover (más oscuro)
                    700: "#0f3f6f", // Dark variant (más oscuro)
                    800: "#0a2a4a", // Darker variant (más oscuro)
                    900: "#051525", // Darkest (más oscuro)
                    950: "#020a12",
                },
            ...
            boxShadow: {
                ...
                "card-hover":
                    "0 4px 12px 0 rgb(0 0 0 / 0.06), 0 2px 4px 0 rgb(0 0 0 / 0.03)",
                dropdown:
