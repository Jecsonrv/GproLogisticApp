...
function ClientForm() {
    ...
    const validateForm = () => {
        ...
        if (formData.payment_condition === "credito") {
            if (!formData.credit_days || formData.credit_days <= 0) {
                newErrors.credit_days = "Los días de crédito son requeridos para condición de crédito";
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const dataToSend = {
                ...formData,
                credit_days: formData.payment_condition === "credito" ? parseInt(formData.credit_days) : 0,
                credit_limit: formData.payment_condition === "credito" ? parseFloat(formData.credit_limit) : 0,
            };
            ...
            const errorMessage = error.response?.data?.nit?.[0] ||
                    ...
                    <CardHeader>
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <CardDescription>Datos fiscales y de identificación</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <p className="text-xs text-slate-500 mt-1">
                                    Opcional. Usar si difiere del nombre comercial.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    onChange={(e) => handleChange("iva_registration", e.target.value)}
                        ...
                        <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                            <div className="flex items-start gap-3">
                                <input
                                    ...
                                    onChange={(e) => handleChange("is_gran_contribuyente", e.target.checked)}
                                    className="mt-1 h-4 w-4 text-brand-600 rounded border-slate-300 focus:ring-brand-500"
                                />
                                <div>
                                    <label htmlFor="is_gran_contribuyente" className="text-sm font-medium text-amber-900 cursor-pointer">
                                        Gran Contribuyente
                                    </label>
                                    <p className="text-xs text-amber-700 mt-0.5">
                                        Si está marcado, se aplicará retención del 1% en facturas CCF (El Salvador).
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <CardHeader>
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <CardDescription>Datos para comunicación y envío de documentos</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-4">
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                <CardTitle>Condiciones de Pago y Crédito</CardTitle>
                                <CardDescription>Configuración de términos de pago y límites de crédito</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mt-2">
                                <button
                                    type="button"
                                    onClick={() => handleChange("payment_condition", "contado")}
                                    className={cn(
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-medium text-slate-900">Contado</p>
                                            <p className="text-xs text-slate-500">Pago inmediato al momento de facturar</p>
                                        </div>
                                    </div>
                                </button>
                                ...
                                <button
                                    type="button"
                                    onClick={() => handleChange("payment_condition", "credito")}
                                    className={cn(
                                        "p-4 rounded-lg border-2 text-left transition-all",
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500">Pago diferido según días acordados</p>
                                        </div>
                                    </div>
                                </button>
                            </div>
                        ...
                        {formData.payment_condition === "credito" && (
                            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-4">
                                <div className="flex items-center gap-2 text-blue-800">
                                    ...
                                    <span className="text-sm font-medium">Configuración de Crédito</span>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        {errors.credit_days && (
                                            <p className="text-xs text-red-600 mt-1">{errors.credit_days}</p>
                                        )}
                                        <p className="text-xs text-blue-700 mt-1 flex items-center gap-1">
                                            <Calendar className="h-3 w-3" />
                                            Las facturas vencerán automáticamente después de este plazo
                                        </p>
                                    </div>

                                    <div>
                                        <Label required>Límite de Crédito</Label>
                                        <div className="relative">
                                        ...
                                        {errors.credit_limit && (
                                            <p className="text-xs text-red-600 mt-1">{errors.credit_limit}</p>
                                        )}
                                        <p className="text-xs text-blue-700 mt-1 flex items-center gap-1">
                                ...
                                {formData.credit_days > 0 && (
                                    <div className="p-3 bg-white rounded-lg border border-blue-200">
                                        <p className="text-sm text-blue-900">
                                            <span className="font-medium">Ejemplo:</span> Una factura emitida hoy (
                                            {new Date().toLocaleDateString("es-SV")}) vencerá el{" "}
                                            <span className="font-semibold">
                                                {new Date(
                                                    Date.now() + formData.credit_days * 24 * 60 * 60 * 1000
                    ...
                    <CardHeader>
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <CardDescription>Información adicional y estado del cliente</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <label htmlFor="is_active" className="cursor-pointer">
                                    ...
                                    <p className="text-xs text-slate-500">
                                        Los clientes inactivos no aparecerán en listas de selección
                                    </p>
                                </label>
                            </div>
