    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                secondary:
                    "bg-slate-100 text-slate-700 hover:bg-slate-200 hover:text-slate-900 focus-visible:ring-slate-900",
                // Botón outline - Acciones terciarias
                outline:
                    "border border-slate-300 bg-white text-slate-700 shadow-sm hover:bg-slate-50 hover:border-slate-400 focus-visible:ring-slate-900",
                // Botón ghost - Sin fondo visible
                ghost: "text-slate-600 hover:bg-slate-100 hover:text-slate-900 focus-visible:ring-slate-900",
                ...
                link: "text-slate-700 underline-offset-4 hover:underline hover:text-slate-900 focus-visible:ring-slate-900",
